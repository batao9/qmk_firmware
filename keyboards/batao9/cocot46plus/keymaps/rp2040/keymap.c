...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
     ...
     KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_BTN1,          KC_BTN2,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,   KC_UP,
     KC_LCTL, KC_LGUI, KC_LNG2,           KC_SPC,   KC_FN1,          KC_BTN1,           KC_FN2,  KC_SPC, KC_LNG1,          KC_LEFT, KC_DOWN, KC_RGHT,
                                                            KC_WH_U,          KC_WH_D
    ),
